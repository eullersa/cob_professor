                    ...
                    <Fragment key={i}>
                        <div className="course" style={{width: "100%"}}>
                            <div className="left">
                                ...
                                <div>
                                    <Link to={`${link}/${course._id}`} style={{color: 'inherit', textDecoration: 'none'}}><div className="name">{course.name}</div></Link>
                            ...
                            <div className="right">
                                ...
                                <div className="edit" onClick={(() => setForm({form: "prices", ...courses[i]}))}>preços</div>
                                <div className="edit" onClick={(() => setForm({form: "live", ...courses[i]}))}>live</div>
                            </div>
                        </div>                    
                    </Fragment>
                )
