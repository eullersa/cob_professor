...
function Form({text, button, setForm, inputs, setCourses, photoModel, course}) {
                      ...
                      <div className="form-group" key={i}>
                        {(() => {
                          if(input.type === 'file') {
                            ...
                            return (
                              <>
                              <input style={{marginBottom: 17}} type="text" onChange={handleChange(input.setInput)} value={data[input.setInput]} className="form-control" placeholder={input.placeholder} required />
                              </>
                            )
                          } else {
                            return (
