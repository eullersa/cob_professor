    ...
    return (
        <div id='profile'>
            ...
            <div className="informations">
                <h6>Configurações</h6>
                <Link style={{textDecoration: 'none'}} to='/dashboard'><p>Minha conta</p></Link>
                <Link style={{textDecoration: 'none'}} to='/dashboard'><p>Meus alunos</p></Link>
                <Link style={{textDecoration: 'none'}} to='/dashboard'><p>Meus sites</p></Link>
                <Link style={{textDecoration: 'none'}} to='/dashboard'><p>Faturas</p></Link>
            </div>
        </div>
    );
}
